local atuin = import 'lib/atuin.libsonnet';
...
local options = {
  ...
  stats: atuin.Stats(common_subcommands, common_prefix, ignored_commands),
  keys: atuin.Keys(),
  sync: atuin.Sync(),
  preview: atuin.AutoPreview,
  daemon: atuin.DisabledDaemon,
  theme: atuin.Theme(),
  search: atuin.Search(search_filters),
};
